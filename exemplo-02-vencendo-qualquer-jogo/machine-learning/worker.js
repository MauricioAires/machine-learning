...
async function loadModelAndLabels() {
  ...
  /**
   * Limpar da memoria para não causar vazamento de memória
   */
...
function preprocessImage(input) {
  /**
   * criar a função dentro do tidy faz com que você
   * não precise executar o comando dispose para liberar
   * a memória porque o tidy já faz isso automaticamente.
   */
  return tf.tidy(() => {
